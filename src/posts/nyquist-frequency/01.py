...
# This brings us full circle, back to the intuitive idea that our sampling process must adequately capture high frequency oscillations i.e. we need more than two samples per cycle of the highest frequency contained in the continuous signal.
#
